          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                _infoRow(context, Icons.airline_seat_recline_normal_outlined,
                    "Вільних місць:", "$seats"),
                ...
                // Список пасажирів (тільки для водія)
                if (isDriver) ...[
                  const Text(
                    "Пасажири",
                    style: TextStyle(
                  ...
                  StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (docs.isEmpty) {
                        return const Text("Пасажирів ще немає 😕",
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, i) {
                          ...
                          return ListTile(
                            ...
                            title: Text(p['userName'] ?? 'Анонім',
                                style: const TextStyle(
                                    color: Colors.black, fontWeight: FontWeight.w700)),
                            subtitle: const Text("Забронював місце",
                                style:
                ...
                // Кнопка Бронювання (тільки для пасажира)
                if (!isDriver)
                  StreamBuilder<bool>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      // Якщо ми в режимі "Мої поїздки" і користувач звільнив місце — ховаємо кнопку
                      if (showOnlyFreeUp && !joined) {
                      ...
                      return SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(
                            joined ? "Звільнити місце" : "Забронювати місце",
                            style: const TextStyle(
